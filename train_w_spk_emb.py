...
from meldataset import MelDataset, get_dataset_direct_filelist, mel_spectrogram
from models import (
    Generator,
...
def train(rank, a, h):
    ...
    training_filelist, validation_filelist = get_dataset_direct_filelist(a)
    ...
    trainset = MelDataset(
        ...
        wav_to_spk_emb_path=h.train_wav_to_spk_emb_path,
    )
    ...
    if rank == 0:
        validset = MelDataset(
            ...
            fine_tuning=a.fine_tuning,
            base_mels_path=a.input_mels_dir,
            wav_to_spk_emb_path=h.valid_wav_to_spk_emb_path,
        )
                ...
                if steps % a.validation_interval == 0:  # and steps != 0:
                    ...
                    with torch.no_grad():
                        for j, batch in enumerate(validation_loader):
                            x, y, _, y_mel, spk_emb = batch
                            y_g_hat = generator(x.to(device), g=spk_emb.to(device))
